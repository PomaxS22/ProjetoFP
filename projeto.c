...
void ler_dificuldade(char dificuldade[])
{
    ...
    {
    case 1:
        strcpy(dificuldade, "baixo");
        break;
    case 2:
        strcpy(dificuldade, "medio");
        break;
    case 3:
        strcpy(dificuldade, "elevado");
        break;
    }
}
...
int ler_dados_arquivo(Estudante estudantes[], int *num_estudantes, Ficha fichas[], int *num_fichas, Exercicio exercicios[], int *num_exercicios,
                      Submissao submissoes[], int *num_submissoes)
{
